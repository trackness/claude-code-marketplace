#!/usr/bin/env python3
"""ECMAScript lexer conformance and '/'-as-division vs '/'-as-regex.

Target: ``plugins/model-guard/scripts/enforce_explicit_model.py``. The hook's
*behaviour* is the contract; this module pins the lexer contract, because the
lint runs on the token stream:
...
from helpers import HookTestCase, workflow_script
